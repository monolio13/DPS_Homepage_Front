    ...
    <section
      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="flex items-center gap-4">
          <h2 className="text-xl sm:text-3xl md:text-5xl font-extrabold text-[#4d4e59] tracking-tight">
            사용 후기
          </h2>
          <img
            src="/images/sis.png"
        ...
        <div className="space-y-10 text-sm sm:text-base md:text-lg">
          {/* Message 1 - Left */}
          <div className="w-full max-w-4xl mx-auto flex items-start gap-4 sm:gap-6">
            <img
              src="/images/001.png"
              alt="user1"
            ...
            <div className="relative w-full bg-gradient-to-r from-[#bde0fe] to-[#a2d2ff] backdrop-blur-lg text-gray-900 px-5 sm:px-6 py-5 sm:py-8 rounded-[26px] rounded-bl-none shadow-2xl font-medium leading-relaxed tracking-wide">
              <span className="font-extrabold text-2sm sm:text-base md:text-lg lg:text-xl xl:text-3xl text-[#157CFF] block mb-3">
                "셀퍼럴 수수료를 받는 순간 감동"
              </span>
          ...
          {/* Message 2 - Right */}
          <div className="w-full max-w-4xl mx-auto flex items-start justify-end gap-4 sm:gap-6 text-right">
            <div className="relative w-full bg-gradient-to-r from-[#57a0ff]/80 to-[#006aff]/80 backdrop-blur-md text-white px-5 sm:px-6 py-5 sm:py-8 rounded-[26px] rounded-br-none shadow-2xl font-medium leading-relaxed tracking-wide">
              <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold">
                <span className="font-extrabold text-2sm sm:text-lg md:text-xl lg:text-3xl block mb-2">
                  "일단 한 번 신청해보세요"
                </span>
              ...
              <div className="absolute  right-5 text-xs sm:text-sm text-white/80 font-semibold">
                임** 고객님
              </div>
            </div>
          ...
          <div className="w-full max-w-4xl mx-auto flex items-start gap-4 sm:gap-6">
            ...
            <div className="relative w-full bg-gradient-to-br from-white via-pink-50 to-rose-100 border border-rose-200 backdrop-blur-lg text-gray-900 px-5 sm:px-6 py-5 sm:py-8 rounded-[26px] rounded-bl-none shadow-2xl font-medium leading-relaxed tracking-wide">
              <span className="font-extrabold text-2sm sm:text-lg md:text-2xl lg:text-3xl text-[#157CFF] block mb-3">
                "공돈 생기는데 안할 이유 없죠"
              </span>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-gray-800">
                거래소를 바꾸는게 번거롭게 느껴졌는데, 한 번 바꾸고 나면
                번거로울게 없어요.
                <br className="hidden sm:block" />한 번 번거로우면, 평생 꽁돈이
                생겨요.
              </p>
              <div className="absolute bottom-1 right-5 text-xs sm:text-sm text-gray-600 font-semibold">
                최** 고객님
